function App() {
  return (
    <main className='h-screen w-full bg-[#D6E2EF] flex items-center justify-center font-[Outfit] text-[15px]'>
      <section className=' bg-[#FFFFFF] rounded-2xl shadow-sm flex flex-col justify-center items-center mx-5'>
